        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="liste_carte.php"><i class="fa fa-fw fa-table"></i> carte</a>
                    </li>
                    
                    <li>
                        <a href="alltransaction.php"><i class="fa fa-money fa-fw"></i> transaction </a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Dashboard <small>de admin</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
